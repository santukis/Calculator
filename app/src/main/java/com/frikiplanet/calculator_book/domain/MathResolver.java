...
public class MathResolver implements Resolver {
    ...
    public Double resolve(List<String> symbols) {
        ...
        while (symbols.size() > 1) {
            ...
            symbols.set(operatorPosition, result.toString());
            replaceOperands(operator, operatorPosition, symbols);
        }
    ...
    private void replaceOperands(Operation operator, int operatorOrder, List<String> symbols) {
        if (operatorOrder + 1 < symbols.size()) {
